        ...
        {({ values, handleChange, handleBlur, setFieldValue }) => (
          <Form>
            <div className='bg-white dark:bg-gray-800 p-7 my-2 drop-shadow-md rounded-lg'>
              <div className="flex flex-wrap">
                <div className=" w-96 px-3">
                  ...
                  <Field className="appearance-none block w-full my-2 bg-gray-100 text-gray-700 border border-gray-200 rounded py-2 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                    id="Create_Group"
                    name='Create_Group'
                    type="text"
...

                  {
                    values.uploadimage ? (<div className='flex '> <img className='h-16 mt-2' src={values.uploadimage} alt="" /> <TiDeleteOutline className='text-3xl text-red-600' onClick={() => setFieldValue("uploadimage", '')} /> </div>) :
                      (<label htmlFor='uploadimage'
                        className="w-44 h-[38px]  cursor-pointer px-3 mx-3 mt-8 py-1 bg-gray-100 border border-blue-600 flex  items-center justify-center  rounded" >
                        <MdUploadFile
                ...
                <div className="w-full my-2 px-3">
                  ...
                  <Field
                    ...
                    name='description'
                    rows="3"
                    className="block my-2 p-2.5 w-3/4 text-sm text-gray-700  rounded  border-gray-200  focus:border-gray-500 focus:bg-white bg-gray-100  "
                    ...
                    values.term.map((term, index) => (
                      <div key={index} className='my-5 flex flex-wrap' >
                        ...
                        <div className=" w-[335px] px-3">
                          ...
                          <input
                            ref={addRefs}
                            className="appearance-none block w-full my-2 bg-gray-100 text-gray-700 border border-gray-200 rounded py-2 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
            ...
            <div className="h-28 flex  items-center justify-center">
              ...
              <button type='submit'
                className="bg-red-600 hover:bg-red-700 font-bold py-2 px-14 rounded text-white from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 shadow-lg shadow-red-500/50 dark:shadow-lg dark:shadow-red-800/60 text-center ">
                Create
              </button>
            </div>
          </Form>
